...
class Rectangle {
	private static var __limeRectangle:Rectangle;
	private static var __pool = new ObjectPool<Rectangle>(() -> new Rectangle(), r -> r.setTo(0, 0, 0, 0));
	...
	private function __toLimeRectangle():Rectangle {
		if (__limeRectangle == null) {
			__limeRectangle = new Rectangle();
		}
