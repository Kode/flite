...
class RenderTexture extends SubTexture {
	 ...
	 */
	public function new(width:Int, height:Int, persistent:Bool = true, scale:Float = -1, format:Context3DTextureFormat = null, repeat:Bool = false) {
		if (format == null)
	...
	private function renderBundled(renderBlock:DisplayObject->Matrix->Float->Void, object:DisplayObject = null, matrix:Matrix = null, alpha:Float = 1.0,
