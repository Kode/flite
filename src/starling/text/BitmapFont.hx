...
class BitmapFont {
	...
	public function createSprite(width:Float, height:Float, text:String, fontSize:Float = -1, color:UInt = 0xffffff, hAlign:String = "center",
			vAlign:String = "center", autoScale:Bool = true, kerning:Bool = true):Sprite {
	...
	public function fillQuadBatch(quadBatch:QuadBatch, width:Float, height:Float, text:String, fontSize:Float = -1, color:UInt = 0xffffff,
			hAlign:String = "center", vAlign:String = "center", autoScale:Bool = true, kerning:Bool = true, leading:Float = 0):Void {
	...
	private function arrangeChars(width:Float, height:Float, text:String, fontSize:Float = -1, hAlign:String = "center", vAlign:String = "center",
			autoScale:Bool = true, kerning:Bool = true, leading:Float = 0):Vector<CharLocation> {
			...
			if (mLineHeight <= containerHeight) {
				...
				while (i < numChars) {
					...
					if (charID == CHAR_NEWLINE || charID == CHAR_CARRIAGE_RETURN) {
						...
						trace("[Starling] Font: " + mName + " missing character: " + text.charAt(i) + " id: " + charID);
					} else {
	...
	private function set_smoothing(value:String):String {
		return mHelperImage.smoothing = value;
	}
