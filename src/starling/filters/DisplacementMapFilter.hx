...
class DisplacementMapFilter extends FragmentFilter {
	...
	#else
	private static var sMapTexCoords:Float32Array = new Float32Array([0, 0, 1, 0, 0, 1, 1, 1.0]);
	#end
	...
	public function new(mapTexture:Texture, mapPoint:Point = null, componentX:UInt = 0, componentY:UInt = 0, scaleX:Float = 0.0, scaleY:Float = 0.0,
			repeat:Bool = false) {
