...
class TouchProcessor {
	...
	private function createOrUpdateTouch(touchID:Int, phase:String, globalX:Float, globalY:Float, pressure:Float = 1.0, width:Float = 1.0,
			height:Float = 1.0):Touch {
	...
	private function set_multitapDistance(value:Float):Float {
		return mMultitapDistance = value;
	}
