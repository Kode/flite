...
class Button extends DisplayObjectContainer {
	...
	public function new(upState:Texture, text:String = "", downState:Texture = null, overState:Texture = null, disabledState:Texture = null) {
		super();
		if (upState == null)
	...
	private function get_fontBold():Bool {
		return mTextField != null ? mTextField.bold : false;
	}
