...
class BlendMode {
	...
	public static function register(name:String, sourceFactor:Context3DBlendFactor, destFactor:Context3DBlendFactor, premultipliedAlpha:Bool = true):Void {
		var modes:Map<String, Array<Context3DBlendFactor>> = sBlendFactors[premultipliedAlpha ? 1 : 0];
