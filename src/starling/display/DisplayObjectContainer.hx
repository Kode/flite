...
class DisplayObjectContainer extends DisplayObject {
	...
	private function set_touchGroup(value:Bool):Bool {
		return mTouchGroup = value;
	}

	// helpers

	private static function mergeSort(input:Vector<DisplayObject>, compareFunc:DisplayObject->DisplayObject->Int, startIndex:Int, length:Int,
	 ...
	 * issues. */
	private function __spliceChildren(startIndex:Int, deleteCount:Int = Max.INT_MAX_VALUE, insertee:DisplayObject = null):Void {
	...
	/** @private */
	private function __getChildEventListeners(object:DisplayObject, eventType:String, listeners:Vector<DisplayObject>):Void {
