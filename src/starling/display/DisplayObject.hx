...
class DisplayObject extends EventDispatcher {
	...
	public function hitTest(localPoint:Point, forTouch:Bool = false):DisplayObject {
		...
		if (mMask != null && !hitTestMask(localPoint))
			return null;
	...
	public function alignPivot(hAlign:String = "center", vAlign:String = "center"):Void {
		...
		if (hAlign == HAlign.LEFT)
			...
			mPivotX = bounds.x + bounds.width / 2.0;
		...
		if (vAlign == VAlign.TOP)
			...
			mPivotY = bounds.y + bounds.height / 2.0;
	...
	@:final private function __findCommonParent(object1:DisplayObject, object2:DisplayObject):DisplayObject {
